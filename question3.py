...
print("Match_ID and Unique_Team_ID with the corresponding Team_Name.Using WHERE statement :,")
...
print(" The Unique_Team_ID and TeamName from Unique_Teams and AvgAgeHome, Season and ForeignPlayersHome from Teams, return the first five rows : ")
